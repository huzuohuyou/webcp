...
tree.add(201, 200, "URL传递(GET)", context+"/bioscenter/url_params.jsp", "", "mainFrame", "img/report.gif");
tree.add(202, 200, "表单提交(POST)", context+"/bioscenter/form_params.jsp", "", "mainFrame", "img/report.gif");
...
tree.add(702, 700, "表头锁定", context+"/ReportEmitter?rpt=Demo/中国式报表/表头锁定.brt", "", "mainFrame", "img/report.gif");
tree.add(703, 700, "字体自动调整", context+"/ReportEmitter?rpt=Demo/中国式报表/字体自动调整.brt", "", "mainFrame", "img/report.gif");
tree.add(704, 700, "子报表", context+"/ReportEmitter?rpt=Demo/中国式报表/子报表演示.brt&params=path_prefix=Demo/", "", "mainFrame", "img/report.gif");

tree.add(800, 1, "TagLib部署", "", "", "", "img/folder.gif");
tree.add(801, 800, "单页数据", context+"/bioscenter/common_tag.jsp?rpt=Demo/复杂扩展/4横向纵向分片.brt", "", "mainFrame", "img/report.gif");
tree.add(802, 800, "多页数据", context+"/bioscenter/common_tag.jsp?rpt=Demo/分组报表/5分组汇总.brt", "", "mainFrame", "img/report.gif");
tree.add(803, 800, "多表标签", context+"/bioscenter/reportset_tag.jsp", "", "mainFrame", "img/report.gif");
...
tree.add(1001, 1000, "参数表单", context+"/bioscenter/param_query.jsp?rpt=Demo/参数报表/时间参数.brt", "", "mainFrame", "img/report.gif");
...
tree.add(1303, 1300, "分析报表", context+"/bioscenter/analysis.jsp", "", "mainFrame", "img/report.gif");
tree.add(1305, 1300, "分析报表2", context+"/bioscenter/analysis2.jsp", "", "mainFrame", "img/report.gif");
tree.add(1304, 1300, "动态统计", context+"/bioscenter/dynquery.jsp", "", "mainFrame", "img/report.gif");
...
tree.add(1501, 1500, "批量导出", context + "/bioscenter/export.jsp", "", "mainFrame", "img/report.gif");
...
<%
	for(int i=0;i<dataItems.size();i++){
	  	...
	  	switch(item.getType()){
	  		...
	  		case DataItem.FILE:{
	  		%>
	  			customTree.add(<%=item.getId()%>, <%=item.getParentId()%>, "<%=item.getName()%>", "/DcpProject/<%=item.getUrl()%>", "", "mainFrame", "img/report.gif");
	  		<%
	  			break;
	  		}
	  	}
