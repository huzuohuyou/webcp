...
$(function(){
	 var queryStringByName= function (queryName) {
		...
		$("#gridTable").jqGrid({
		url:'../ZhikongPatientServlet?op=nurse&patientNo='+patient_no,
		datatype: "json",
		...
		colModel:[
					{name:'LOCAL_KEY',index:'LOCAL_KEY', width:70,align:"center",sortable:false,search:false },
					{name:'LOCAL_CODE',index:'LOCAL_CODE', width:70,align:"center",sortable:false,search:false},
					{name:'LOCAL_NAME',index:'LOCAL_NAME', width:160,align:"center",search:false,sortable:false},
					...
					{name:'NURSE_NO',index:'NURSE_NO', width:80,align:"center",sortable:false,search:false }
