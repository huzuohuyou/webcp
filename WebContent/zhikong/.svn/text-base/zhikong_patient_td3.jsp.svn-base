...
$(function(){
	 var queryStringByName= function (queryName) {
		...
		$("#gridTable").jqGrid({
		url:'../ZhikongPatientServlet?op=diaAndOperaInfo&patientNo='+patient_no,
		datatype: "json",
		//height:( $(document).height()-90),
		beforeRequest:function(){//每次读取前先清空表中数据
			 $(this).clearGridData("clearfooter");
		},
		colNames:['院内系统主键', '院内系统编码','项目说明','诊断/手术','下达人','下达时间','对应中心编码'],
		colModel:[
					{name:'LOCAL_KEY',index:'LOCAL_KEY', width:100,align:"center",sortable:false,search:false },
					{name:'INCOME_CODE',index:'INCOME_CODE', width:100,align:"center",sortable:false,search:false},
					{name:'LOCAL_NAME',index:'LOCAL_NAME', width:120,align:"center",search:false,sortable:false},
					{name:'INCOME_TYPE',index:'INCOME_TYPE',width:50,align:"center",search:false,sortable:false }	,
					...
					{name:'LOCAL_CODE',index:'LOCAL_CODE', width:80,align:"center",sortable:false,search:false }
