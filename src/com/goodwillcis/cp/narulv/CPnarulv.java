...
public class CPnarulv implements CustomDataSet {
...
/*		if (start_time == null||"".equals(start_time)) {
	...
	stmt = conn.prepareCall("{call GET_DATA.BBSJ_PRO (?,?,?,?)}");
    ...
    /*		if(cp_id>10000){
    	    ...
    	    nr_avg_fee = rs.getDouble(12);
    	    wnr_avg_fee = rs.getDouble(13);
    	    nr_avg_days = rs.getInt(14);
    	    wnr_avg_days = rs.getInt(15);
    	    data.add(new Object[] {
    	    		cp_name,
    	    		fhrs,
    	    		wnrrs,
